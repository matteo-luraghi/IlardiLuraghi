...
log into the S\&C platform. On the homepage they are greeted with a list of available internships, they browse them and then select the one which suits them the most.
...
Student C receives a notification about an internship from a specific Company D who reached out to them, they log into the S\&C's platform. From the homepage, they navigate to the "Company proposals" section and select the internships they want to check out. The system shows Student C the page containing the internship's details, and they click on the "Apply" button to enrol. Consequently, the system prompts a confirmation message and redirects Student C to the homepage.
\newline
\newline
\textbf{Student applies to an internship recommended by the system }\newline
Student E wants to look for available internships that match their skills and experiences, so they
log into the S\&C platform. From the homepage, they navigate to the "Suggestions" section, where there's a list of internships recommended by the system based on Student E's skills and experiences, they browse them and then select the one which suits them the most.
The system shows Student E the page containing the internship's details, they click on the "Apply" button to enrol. Consequently, the system prompts a confirmation message and redirects Student B to the homepage.
\newline
\newline
\textbf{Company creates an internship announcement}\newline
Company F wants to create an announcement for a newly available internship, so it logs into the S\&C platform. From the homepage, it navigates to the "Internships" section, where it can click the "New" button and fill the form with all the necessary information. After completing the form, the company can click the "Submit" button to create the internship announcement.
\newline
\newline
\textbf{Company reviews a student's application}\newline
Company G logs into the S\&C platform to review student applications for an internship. From the homepage, it navigates to the "Internships" section, which displays a list of internship announcements posted by the company. Company G selects a specific internship by clicking on it, which opens a detailed view of the internship.
Within the internship's page, Company G accesses the "Applications" section, where it finds Student H's application. The system displays the detailed application, including Student H's profile and CV, by clicking on the application. After reviewing the CV, Company G decides to either accept or reject the application.
\newline
\newline
\textbf{Student and company set up the interview}\newline
After approving Student I's application, Company I navigates to the "Interviews" section of the S\&C platform. Here, Company L selects and proposes three possible dates and times for the interview.
Student I, upon logging into the platform, accesses the "Interviews" section to view the proposed dates. Student I can either:
accept one of the suggested dates by clicking on it, confirming the choice; 
request a new set of dates by clicking the "Reschedule" button, prompting Company L to provide alternative options.
\newline
\newline
\textbf{Student and company meet for the interview}\newline
At the agreed-upon date and time, Company M and Student N log into the S\&C platform using their credentials. Both navigate to the "Interviews" section, where a link to the third-party meeting application is available. By clicking the link, they are redirected to the meeting platform and start the interview.
\newline
\newline
\textbf{Company reaches out to student offering an internship}\newline
Company O logs into the S\&C platform to identify a suitable candidate for one of its internships. From the homepage, Company O navigates to the "Internships" section and selects a specific internship.
Within the internship's page, Company O accesses the "Suggestions" section, where the system provides a list of recommended students. After reviewing the suggestions, Company O selects the most suitable student and clicks the "Notify" button to send Student P a notification encouraging them to apply for the internship. If they accept the offer, they are ready to schedule an interview, without the need from Company O to evaluate Student P's CV again.
\newline
\newline
\textbf{Student provides feedback on an internship}\newline
RICORDARE METTERE ANCHE POSSIBILITA' DI RISPONDERE
\newline
\newline
...
\begin{enumerate}[label={[R\arabic{enumi}]}]
    ...
    \item The System shall allow Companies to see feedback about Students from past internships partook in
\end{enumerate}
