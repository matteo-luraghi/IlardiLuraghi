...
log into the S\&C platform. From the homepage, they navigate to the "Suggestions" section, where there's a list of internships recommended by the system based on Student D's skills and experiences, they browse them and then select the one which suits them the most.
The system shows Student B the page containing the internship's details, they click on the "Apply" button to enrol. Consequently, the system prompts a confirmation message and redirects Student B to the homepage.
\newline
\newline
