...
\begin{enumerate}[label={[G\arabic{enumi}]}]
    ...
    \item Students find internships that align with their skills, experiences, and preferences.
    \item Students are notified when internships matching their profile become available
    \item Companies are notified when suitable student profiles (CVs) are uploaded or updated
...
The scope of the S\&C platform includes:
\begin{itemize}
    \item Enabling students to search, apply, and track internships
    \item Allowing companies to post internship opportunities and evaluate applicants
    \item Facilitating the recommendation of internships and students through tailored algorithms
    \item Supporting the interview and selection process for companies
    \item Providing tools for feedback and monitoring for both companies and students
\end{itemize}

\subsection{World Phenomena }
\begin{enumerate}[label={[WP\arabic{enumi}]}]
    \item Students update their CVs based on their experiences
...
\begin{enumerate}[label={[SP\arabic{enumi}]}]
    \setcounter{enumi}{9} % need to update if the number of world controlled changes
    ...
    \item The system logs complaints from students
    \item The system logs complaints from companies
    \item The system tracks the status of matchmaking processes and ongoing internships
    \item The system provides reports on internship outcomes and matching statistics
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Overall Description}: it is a high-level description of how the system works with
    ...
    \item \textbf{Specific Requirements}: this section provides a detailed analysis of the requirements needed to achieve the goals. Moreover, it contains more information useful for
    developers (i.e. constraints about HW and SW)
